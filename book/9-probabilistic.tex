...
Those earlier examples form a labeled \emph{reference dataset}, which helps us estimate performance for each new batch of
predictions, or \emph{chunk} in the figures. We keep the reference examples separate from the monitored model's training data
and validate the estimator on held-out data.
