...
The \emph{reference dataset} contains earlier examples that the model did not use for training, along with its predictions and
their actual outcomes. We use it to estimate performance on new data and check those estimates on another labeled dataset.
