...
\begin{figure*}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/RMSE_sensitivity_outliers_plot.png} % Increased width for better visibility
\end{figure*}
...
\vspace{10pt} % Added spacing to prevent overlap with the wrapfigure
...
% Left text with the image on the right
\textbf{Figure 3.7 sMAPE.}Highlights the behavior of sMAPE. Unlike MAPE, sMAPE remains bounded but still exhibits extreme values 
