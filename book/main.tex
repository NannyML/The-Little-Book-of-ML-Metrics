...
\newenvironment{decisionmap}[4]{%
    ...
    \vspace{6pt}
    % text-only lines may be ragged; lines ending in a metric are still pulled to the margin by the leader's fill glue
    \begingroup\small\setlength{\parindent}{0pt}\setlength{\parskip}{0pt}\setlength{\leftskip}{0pt}\setlength{\rightskip}{0pt plus 1fil}\setlength{\emergencystretch}{2em}\nohyph
}{%
    \endgroup\clearpage
}
