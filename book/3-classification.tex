...
\begin{center}
    \tikz{
        \node[inner sep=2pt, font=\Large] (a) {
            {
                $\displaystyle
                \textbf{F1} = \frac{\textbf{2}}{\textcolor{nmlcyan}{\textbf{P}^{-1}} + \textcolor{nmlpurple}{\textbf{R}^{-1}}} = \frac{\textbf{2}\textcolor{nmlred}{\textbf{TP}}}{\textbf{2}\textcolor{nmlred}{\textbf{TP}} + \textcolor{nmlgreen}{\textbf{FP}} + \textcolor{gray}{\textbf{FN}}}
                $
            }
        };
    \draw[-latex, nmlcyan, semithick] ($(a.south)+(-2.7,0.1)$) to[bend left=25] node[pos=1, left] {\textbf{\color{nmlcyan} precision}} +(-.6, -.5);
    \draw[-latex, nmlpurple, semithick] ($(a.south)+(-1.2, 0.1)$) to[bend left=-35] node[pos=1, right] {\textbf{\color{nmlpurple} recall}} +(0.7, -.9);
    \draw[-latex, nmlgreen, semithick] ($(a.south)+(2.3,0.1)$) to[bend left=35] node[pos=1, left] {\textbf{\color{nmlgreen} false positive}} +(-0.5, -.4);
    \draw[-latex, gray, semithick] ($(a.south)+(3.4, 0.1)$) to[bend left=-30] node[pos=1, right] {\textbf{\color{gray} false negative}} +(0.7, -.6);
    \draw[-latex, nmlred, semithick] ($(a.south)+(2.3, 1.1)$) to[bend right=-40] node[pos=1, right] {\textbf{\color{nmlred} true positive}} +(0.7, .6);
    }
\end{center}
