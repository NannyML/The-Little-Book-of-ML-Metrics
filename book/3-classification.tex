...
\begin{center}
    \tikz
        \node[inner sep=2pt, font=\Large] (a) {
            {
                $\displaystyle
                F1 = \frac{2}{\textcolor{white!25!blue}{P}^{-1} + \textcolor{violet}{R}^{-1}} = \frac{2\textcolor{white!25!red}{TP}}{2\textcolor{white!25!red}{TP} + \textcolor{teal!60!green}{FP} + \textcolor{gray}{FN}}
                $
            }
        };
   \draw[-latex, white!25!blue, semithick] ($(a.south)+(-2.7,0.1)$) to[bend left=25] node[pos=1, left] {\scriptsize \textbf{\color{white!25!blue} precision}} +(-.6, -.5);
    \draw[-latex, white!25!violet, semithick] ($(a.south)+(-1, 0.1)$) to[bend left=-35] node[pos=1, right] {\scriptsize \textbf{\color{white!25!violet} recall}} +(0.8, -.9);
     \draw[-latex, teal!60!green, semithick] ($(a.south)+(2.2,0.1)$) to[bend left=35] node[pos=1, left] {\scriptsize \textbf{\color{teal!60!green} false positive}} +(-0.5, -.4);
      \draw[-latex, gray, semithick] ($(a.south)+(3.4, 0.1)$) to[bend left=-30] node[pos=1, right] {\scriptsize \textbf{\color{gray} false negative}} +(0.7, -.6);
       \draw[-latex, white!25!red, semithick] ($(a.south)+(2.3, 1.1)$) to[bend right=-40] node[pos=1, right] {\scriptsize \textbf{\color{white!25!red} true positive}} +(0.7, .6);
