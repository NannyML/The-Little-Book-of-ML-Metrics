...
\coloredboxes{
    \item Simple and intuitive since it directly measures the proportion of shared elements between two sets.  
    \item Bounded between 0 and 1 which makes it easy to interpret across different applications.  
}
{
...
\clearpage
% inspo : https://towardsdatascience.com/you-dont-know-jacc-ard-f2c05c7ea039/
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figures/Jaccard_Low.png}
  \label{fig:test1}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{figures/Jaccard_High.png}
  \label{fig:test2}
\end{minipage}%
...
The Jaccard Index can be misleading because it treats similarity as a purely reciprocal relationship i.e. it only considers the proportion of overlap relative to the total union of the sets. 
